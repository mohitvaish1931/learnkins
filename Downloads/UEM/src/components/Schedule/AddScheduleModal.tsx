...
const AddScheduleModal: React.FC<AddScheduleModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Allow arrival earlier than departure (overnight trips).
    // Backend will adjust arrival to next day when appropriate.
    if (!formData.departureTime || !formData.arrivalTime) {
      setError('Please provide both departure and arrival times');
      setLoading(false);
      return;
    }
